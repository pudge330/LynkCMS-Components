<?php
/**
 * This file is part of the LynkCMS Command Component.
 *
...
/**
 * Single-class with console helper functions for pure PHP console applications without 3-party libraries.
 */
class ConsoleHelper {
