...
class DataValidator {
	 ...
	 * @return bool True if valid, false otherwise.
	 */
	public function text($text, $min = null, $max = null) {
	 ...
	 * @param int $min Optional. Min value.
	 * @param int $max Optional. Max value.
	 * 
	 * @return bool True if valid, false otherwise.
	 */
	public function int($int, $min => null, $max => null) {
		...
		$passedMaxTest = $max === null || ($passedNumericalTest && (int)$int <= $max);
	 ...
	 * @return bool True if valid, false otherwise.
	 */
	public function double($double, $min = null, $max = null) {
		$passedNumericalTest = is_numeric($double);
		$passedDoubleTest = is_double((double)$double);
		$passedMinTest = $min === null || ($passedNumericalTest && (double)$double >= $min);
		$passedMaxTest = $max === null || ($passedNumericalTest && (double)$double <= $max);
	 ...
	 * @return bool True if valid, false otherwise.
	 */
	public function float($float, $min = null, $max = null) {
		$doubleTest = $this->double($float, $min, $max);
