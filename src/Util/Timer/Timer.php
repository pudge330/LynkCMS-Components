...
namespace Lynk\Component\Util\Timer;

use Datetime;
use Lynk\Component\Util\Timer\Event\LogEvent;
...
class Timer {
	...
	/**
	 * @var Symfony\Component\EventDispatcher\EventDispatcher Event dispatcher for timer events.
	 */
