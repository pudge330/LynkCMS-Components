...
namespace BGStudios\Component\Config;
...
class ConfigLoader {
	...
	/**
	 * @var Config Instance of the BGStudios config class.
	 */
	protected $config;

	/**
	 * @param string $root Root directory for file loading.
	 * @param Config $config Optional. Config Instance of the BGStudios config class.
